...
# else:
#     default_timestamp = time.astimezone(timezone(self.pytz_timezone)).strftime("%Y/%m/%d %I:%M %p")
#
# ("TIME", self.message_created_at.split(maxsplit=4)[4], PARSE_MODE_NONE),
# >
# ("TIME", self.message_created_at.split(maxsplit=4)[1], PARSE_MODE_NONE),
#
# construct\message.py
# construct\transcript.py